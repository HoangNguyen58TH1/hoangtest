...
<html lang="en">
    <head>
        ...
        <script src="assets/js/btn_click.js"></script>
                    ...
                    <div class="col-12">
                        <div class="card-box">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <button onclick="click_btn()" type="button" class="btn btn-danger" style="border-radius: 30px">Click me</button>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6 col-lg-6 col-xl-3">
                                    <div class="card-box mb-0 widget-chart-two">
                                        <div class="float-right">
                                            <input class="class_btn_click_input" data-plugin="knob" data-width="80" data-height="80" data-linecap=round
                                                   data-fgColor="#0acf97" value="34" data-skin="tron" data-angleOffset="180"
                                                   data-readOnly=true data-thickness=".1"/>
                                        </div>
                                        <div class="widget-chart-two-content">
                                            <p class="text-muted mb-0 mt-2">Daily Sales</p>
                                            <h3 class="class_btn_click">$35,715</h3>
                                        </div>
                                ...
                                <div class="col-sm-6 col-lg-6 col-xl-3">
                                    <div class="card-box mb-0 widget-chart-two">
                                        ...
                                        <div class="widget-chart-two-content">
                                            ...
                                            <h3 class="class_btn_click">$97,511</h3>
                                        </div>
                                ...
                                <div class="col-sm-6 col-lg-6 col-xl-3">
                                    <div class="card-box mb-0 widget-chart-two">
                                        ...
                                        <div class="widget-chart-two-content">
                                            ...
                                            <h3 class="class_btn_click">$954</h3>
                                        </div>
                                ...
                                <div class="col-sm-6 col-lg-6 col-xl-3">
                                    <div class="card-box mb-0 widget-chart-two">
                                        ...
                                        <div class="widget-chart-two-content">
                                            ...
                                            <h3 class="class_btn_click">$32,540</h3>
                                        </div>
